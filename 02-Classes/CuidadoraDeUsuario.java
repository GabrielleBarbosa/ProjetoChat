...
public class CuidadoraDeUsuario extends Thread
{
	...
	public void run()
	{
		...
		do
		{
			...
			// se for PedidoParaSairDaSala não fazer nada, se for mensagem particular só escrever se for para este usuario
			// receber msgs, avisos de entrada e de saída da sala
		}
